...
<head>
    ...
    background-color: #6b5b95; /* Màu tím đậm cho nền */
    margin: 0;
    padding: 0;
    background-image: url('img/pngtree-futuristic-shape-abstract-background-chemistry-technology-concept-for-website-image_438818.jpg'); /* Đường dẫn tới hình nền */
    background-size: cover; /* Hiển thị hình ảnh sao cho nó che phủ toàn bộ kích thước của body */
...
.container h2 {
    text-align: center;
    margin-bottom: 30px;
    color: #d291bc; /* Màu hồng tím cho tiêu đề */
}
...
.container input[type="submit"] {
    ...
    padding: 10px;
    margin-bottom: 20px;
    border: 1px solid #9370db; /* Màu tím cho viền */
    border-radius: 5px;
    box-sizing: border-box;
}

.container input[type="submit"] {
    background-color: #9370db; /* Màu tím cho nút submit */
    color: white;
    border: none;
    cursor: pointer;
}
...
.container .signin-link {
    ...
    color: #d291bc; /* Màu hồng tím cho liên kết */
}
